<%-- 
    ...
    Created on : May 29, 2023, 12:14:17 PM
    Author     : MSI AD
--%>
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li class="active"><a href="doctor-register.jsp">Doctor Register</a></li>
								</ul>
							</li>	
							...
							<div class="account-content">
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										...
										<!-- Register Form -->
										<form action="https://dreamguys.co.in/demo/doccure/doctor-dashboard.jsp">
