        ...
        <main>
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-7 col-lg-8 col-md-10 ">
                                    ...
                                    <div class="video-icon">
                                        <a class="popup-video btn-icon" href="https://www.youtube.com/watch?v=rrrCjcCCpOM"
                                    ...
                                    <div class="hero__caption">
                                        ...
                                        <h1 data-animation="fadeInUp" data-delay=".3s">Let us care for your birds.</h1>

                                        <p data-animation="fadeInUp" data-delay=".6s">We believe that with our professional
                                            expertise, along with this special care program, your pet will have the best
                                            health.</p>
                                        <a href="#" class="hero-btn" data-animation="fadeInLeft" data-delay=".3s">Book New
                                            Appointment Now <i class="ti-arrow-right"></i> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-7 col-lg-8 col-md-10 ">
                                    ...
                                    <div class="hero__caption">
                                        <span data-animation="fadeInUp" data-delay=".3s">We help to groom your pet</span>
                                        <h1 data-animation="fadeInUp" data-delay=".3s">Let us care for your birds.</h1>
                                        <p data-animation="fadeInUp" data-delay=".6s">Consectetur adipiscing elit, sed do
                                            eiusmod tempor incididunt ut labore et dolore magna sectetur adipisci.</p>
                                        <a href="#" class="hero-btn" data-animation="fadeInLeft" data-delay=".3s">Book New
                                            Appointment Now<i class="ti-arrow-right"></i> </a>
                                    </div>
                                </div>
                ...
                <div class="about-details">
                    <div class="right-caption">
                        ...
                        <div class="about-more">
                            <p class="pera-top">Mollit anim laborum duis adseu dolor iuyn voluptcate velit ess <br>cillum
                                dolore egru lofrre dsu.</p>
                            <p class="mb-65 pera-bottom">Mollit anim laborum.Dvcuis aute serunt iruxvfg dhjkolohr indd re
                                voluptate velit esscillumlore eu quife nrulla parihatur. Excghcepteur sfwsignjnt occa
                                cupidatat non aute iruxvfg dhjinulpadeserunt moll.</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                ...
                                <div class="gallery-img size-img"
                                     style="background-image: url(assets/img/gallery/feather-transplant-1.jpeg);"></div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img size-img"
                                     style="background-image: url(assets/img/gallery/laughinggull.jpg);"></div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img size-img"
                                     style="background-image: url(assets/img/gallery/bath-bird.jpg);"></div>
                            </div>
                        </div>
                        <div class="col-lg-4  col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img size-img"
                                     style="background-image: url(assets/img/gallery/feather-transplant-7.jpeg);"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="contact-form-main pb-top">
                ...
                <div class="from-left d-none d-lg-block">
                    <img src="assets/img/hero/bird-01.jpg" alt="">
                </div>
            </div>
            <!-- Contact form End -->
            <!--? Team Start -->
