<%-- 
    ...
    Created on : May 29, 2023, 4:19:00 PM
    Author     : MSI AD
--%>
...
<html lang="en">
    ...
    <body>
        <%
            ...
            if (request.getAttribute("date") == null || request.getAttribute("time") == null) {
                        ...
                        <ul class="main-nav">
                            ...
                            <li class="has-submenu active">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="active"><a href="booking-success.jsp">Booking Success</a></li>
