<%-- 
    Document   : form-basic-inputs
    Created on : May 29, 2023, 12:29:36 PM
    Author     : MSI AD
--%>
...
<!-- Mirrored from dreamguys.co.in/demo/doccure/admin/form-basic-inputs.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Nov 2019 04:12:54 GMT -->
<head>
        <meta charset="utf-8">
					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li><a class="active" href="form-basic-inputs.jsp">Basic Inputs </a></li>
