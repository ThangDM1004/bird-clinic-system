<%-- 
    ...
    Created on : May 29, 2023, 12:28:05 PM
    Author     : MSI AD
--%>
...
<!-- Mirrored from dreamguys.co.in/demo/doccure/admin/data-tables.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Nov 2019 04:12:56 GMT -->
<head>
        <meta charset="utf-8">
						...
						<ul>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									...
									<li><a class="active" href="data-tables.jsp">Data Table </a></li>
								</ul>
							</li>
							<li class="submenu">
