<%-- 
    Document   : AboutPage
    Created on : May 21, 2023, 7:34:56 PM
    Author     : Minh
--%>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div style="opacity: 100%;" class="logo">
                                <a href="index.html"><img style=" max-width: 180px;" src="assets/img/logo/final_logo.png"
                                        alt=""></a>
                            </div>
                        </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo mb-25">
                                    <a href="index.html"><img style="max-width: 250px;" src="assets/img/logo/final_logo.png"
                                            alt=""></a>
                                </div>
